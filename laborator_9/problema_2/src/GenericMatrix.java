public abstract class GenericMatrix<E extends Number> {
     ...
     */
    protected abstract E add(Long o1, Long o2);

    /**
     * Metoda abstracta pentru inmultirea a doua elemente ale matricelor
     */
    protected abstract E multiply(Long o2, Long o1);
     ...
     * Aduna doua matrice
     */
    public E[][] addMatrix(Long[][] matrix1, Long[][] matrix2) {
     ...
     */
    public E[][] multiplyMatrix(Long[][] matrix1, Long[][] matrix2) {
        // Verifica limitele
        ...
        for (int i = 0; i < result.length; i++) {
            for (int j = 0; j < result[0].length; j++) {
                ...
                for (int k = 0; k < matrix1[0].length; k++) {
                    result[i][j] = add((Long) result[i][j],
                            (Long) multiply(matrix2[k][j], matrix1[i][k]));
                }
            }
        }
        return result;
